...
class Alliance:
    def __init__(self, team1, team2, team3, score, auto, col):
        self.team1 = team1
        self.team2 = team2
        self.team3 = team3
        self.score = score
    ...
    def __str__(self):
        return self.col + " Alliance: " + str(self.team1) + ", " + (self.team2) + ", " + (self.team3)
...
class Match:
    ...
    def __str__(self):
        return "Match # " + str(self.num) + ": (" + str(self.redAlliance.team1.num) + " & " + str(self.redAlliance.team2.num) + " & " + str(self.redAlliance.team3.num) + ") " + str(self.redAlliance.score) + " - " + str(self.blueAlliance.score) + " (" + str(self.blueAlliance.team1.num) + " & " +  str(self.blueAlliance.team2.num) + " & " +  str(self.blueAlliance.team3.num) + ")"
...
def loadMatches(filename):
    ...
    for line in f:
        ...
        red3 = int(line_data[2])
        redscore = int(line_data[3])
        redauto = int(line_data[4])
        redAlliance = Alliance(red1, red2, red3, redscore, redauto, "Red")
        
        blue1 = int(line_data[5])
        blue2 = int(line_data[6])
        blue3 = int(line_data[7])
        bluescore = int(line_data[8])
        blueauto = int(line_data[9])
        blueAlliance = Alliance(blue1, blue2, blue3, bluescore, blueauto, "Blue")
...
for match in matches:
    r = []
    for team in teams:
        if match.redAlliance.team1 == team or match.redAlliance.team2 == team or match.redAlliance.team3 == team:
            r.append(1)
        else:
            r.append(0)
    M.append(r)
    ...
    b = []
    for team in teams:
        if match.blueAlliance.team1 == team or match.blueAlliance.team2 == team or match.blueAlliance.team3 == team:
            b.append(1)
        else:
            b.append(0)
    M.append(b)
